...
class ChambreController extends DefaultController
{
    ...
    */
    public function viewChambre($id) {
     ...
     /*  $chambre = $this->getDoctrine()->getRepository(Chambre::class);
        $chambre = $chambre->find($id);
        if (!$chambre) {
            throw $this->createNotFoundException(
    ...
    public function filter(Request $request)
    {
        ...
        try {    
            ...
            //dd($param);
            if($param == 'entene'){
                //$entene =$this->em->getRepository(Entene::class)->find($val);
                //dd($entene);
                ...
                //$types =$this->em->getRepository(Typechambre::class)->find($val);
                //dd($types);
                $qb = $this->em->createQueryBuilder();
                    $qb->select('c')
                        ->from(Chambre::class, 'c')
